package com.example.nlw_pocket_nearby.ui.components.button
...
// to create components you always need this composable function!

@Composable
fun NearbyButton(
    modifier: Modifier = Modifier, text: String? = null, @DrawableRes iconRes: Int? = null,
    onClick: () -> Unit
) {
    // Modifier parameter - will controle the actions and visibility of my function
